...
import 'package:give_gobble/view/Restaurant/forgot_password/screen_reset_password.dart';
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 400,
                      child: Pinput(
                        controller: Provider.of<ResForgotpassword>(context,
                                listen: false)
                            .otpcontroller,
                        length: 6,
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              int getotp = await Provider.of<ResForgotpassword>(
                                      context,
                                      listen: false)
                                  .confirmOtp();
