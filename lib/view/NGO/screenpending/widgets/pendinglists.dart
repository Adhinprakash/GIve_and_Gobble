...
class PendingListWidget extends StatelessWidget {
  const PendingListWidget({super.key, required this.food, required this.people, required this.time, required this.location, required this.chat});
final String? food;
final String? people;
final String? time;
...
final IconData chat;
  ...
  Widget build(BuildContext context) {
    ...
    onTap: (){
          Navigator.push(
  context,
  MaterialPageRoute(builder: (context) => const ScreenPendingCompleted()),
);
    },
      leading: Container(
        width: 90,
