...
class DonationPageAppbar extends StatelessWidget {
  const DonationPageAppbar({super.key, required this.title,  required this.leading, required this.trailing});
final String title;
...
final String trailing;
  ...
  MaterialPageRoute(builder: (context) => const ScreenHome()),
        ...
        }, child: Text(trailing,style: textStyleFuc(weight: FontWeight.w400, color: kpink, size: 16),)) ,
