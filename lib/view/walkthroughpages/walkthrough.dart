...
class _WalkThroughPagesState extends State<WalkThroughPages> {
  ...
  void initState() {
    ...
    super.initState();
    image1=Image.asset("assets/We can be  the generation  that ends hunger.jpg");
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Text(
                      "Skip",
                      style: textStyleFuc(
                          weight: FontWeight.w500, color: Colors.white, size: 17),
                    ),
                  ),
                  SmoothPageIndicator(
                    controller: controller,
                    ...
                    effect:const SlideEffect(
                        ...
                        activeDotColor: Colors.white, dotColor: Colors.grey,dotHeight: 10,dotWidth: 10),
                  ),
                  onlastpage
                      ? GestureDetector(
                          onTap: () {
